...
//             await axios.post('http://localhost:5001/fill-form', { url, proxy }); //FOR LOCALHOST
//             // await axios.post(process.env.REACT_APP_FILL_FORM_URL, { url, proxy });
...
//             };
//             console.log("URL:", url);
//             console.log("Proxy:", isProxyEnabled ? proxy : '');
//             // await axios.post('http://localhost:5001/fill-form', { url, proxy: isProxyEnabled ? proxy : '' }); // Include proxy only if enabled
//             // await axios.post(process.env.REACT_APP_FILL_FORM_URL, { url, proxy: isProxyEnabled ? proxy : '' });
...
//                                 onChange={() => setIsProxyEnabled(!isProxyEnabled)}
//                             />
//                             Использовать Proxy
//                         </label>
//                     </div>
...
function App() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // const eventSource = new EventSource(`http://localhost:5001/events`); //FOR LOCALHOST
            const eventSource = new EventSource(process.env.REACT_APP_EVENTS_URL);
            // const eventSource = new EventSource('https://backend-server-xply.onrender.com/events');
            // const eventSource = new EventSource('https://backend-server-xply.onrender.com/events');
            ...
            if (useProxy) {
                ...
                // await axios.post('https://backend-server-xply.onrender.com/fill-form-with-proxy', { url, proxy });
            } else {
                ...
                // await axios.post('https://backend-server-xply.onrender.com/fill-form-without-proxy', { url });
            }

...
app.post('/fill-form-without-proxy', async (req, res) => {
    ...
    try {
        ...
        const browserOptions = {
            ...
            // executablePath: '/Users/ayman/Downloads/testing_with_react/backend/.cache/puppeteer/chrome/mac_arm-130.0.6723.69/chrome-mac-arm64/Google Chrome for Testing'
            executablePath: './.cache/puppeteer/chrome/mac_arm-130.0.6723.69/chrome-mac-arm64/Google Chrome for Testing'
        };
